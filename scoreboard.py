...
class Scoreboard:
    ...
    def __init__(self, ai_game):
        ...
        #Prepare the initial screen images
        self.prep_images()

    def prep_images(self):
        """Prepare the initial score, high score, level images and ships left"""
        self.prep_score()
    ...
    def prep_score(self):
        ...
        # Redondea el valor de stats.score a la decena más cercana.
        rounded_score = round(self.stats.score, -1)
        # El :, dentro de la f-string agrega separadores de miles, ej si rounded score = 12450 entonces score:str = 12,450
