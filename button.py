#Módulo de fuentes de Pygame, que permite renderizar texto en pantalla.
import pygame.font
...
class Button:
    ...
    def __init__(self, ai_game, msg):
        ...
        # Crea una fuente del sistema con tamaño 48. None indica que Pygame usará su fuente predeterminada
        self.font = pygame.font.SysFont(None, 48)

        #Crea el rectángulo del botón inicialmente en la esquina (0,0), luego lo reposiciona en el centro de la pantalla.
    ...
    def _prep_msg(self):
        ...
        #Renderiza el texto msg como una imagen (superficie de Pygame).
        #True → activa el antialias (bordes suavizados).
        self.msg_image = self.font.render(self.msg, True, self.text_color, self.button_color)
        #Obtiene el rectángulo de la imagen de texto y lo centra sobre el rectángulo del botón,
